...
export function LeadPage() {
  ...
  const [lead_value, setLead_value] = useState(null);
  const [last_activity_at, setLast_activity_at] = useState(null);
  const [is_qualified, setIs_qualified] = useState(null);
  ...
  useEffect(() => {
    ...
    api.get(`/api/leads/${id}`)
      .then((res) => {
        ...
        setLast_activity_at(lead.last_activity_at.toISOString().split('T')[0]);
